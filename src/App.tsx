        ...
        <div style={{ background: wlConfig.bg, minHeight: '100vh', color: '#fff', overflowX: 'hidden' }}>
          ...
          <div style={{
             ...
             <div style={{ zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '24px' }}>
               ...
               <button onClick={() => setShowAdminPanel(true)} style={{ padding: '16px 36px', background: '#fff', color: '#000', fontSize: '18px', fontWeight: 'bold', border: 'none', borderRadius: '12px', marginTop: '20px', cursor: 'pointer', transition: '0.2s', boxShadow: `0 10px 30px ${wlConfig.accent}44` }} onMouseOver={e=>e.currentTarget.style.transform='scale(1.05)'} onMouseOut={e=>e.currentTarget.style.transform='scale(1)'}>Access Admin Dashboard</button>
             </div>
          </div>
