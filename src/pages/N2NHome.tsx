        ...
        {!isKple && !isVibe100 && (
          <section style={{ maxWidth: '1400px', margin: '40px auto', padding: '0 40px' }}>
            <div style={{
              ...
              <div style={{
                position: 'absolute', inset: 0,
                backgroundImage: `url(${!isB2K ? "/n2n/derek.jpeg" : "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?auto=format&fit=crop&q=80&w=1200"})`,
              ...
              <div className="banner-full-bleed-content" style={{
                ...
                <div style={{
                  ...
                  {!isB2K ? "🏆 Joe Weider's Mr. Olympia Weekend" : "🎤 The Millennium Tour"}
                </div>
                <h2 style={{
                  fontSize: '38px', fontWeight: 900, color: '#fff', margin: '0 0 16px 0',
                  lineHeight: 1.1, letterSpacing: '-1px', textTransform: 'uppercase',
                }}>
                  {!isB2K ? <>62nd Mr. Olympia<br />Las Vegas 2026</> : <>The Boys 4 Life<br />Reunion Tour</>}
                </h2>
                <p style={{
                  fontSize: '15px', color: 'rgba(255,255,255,0.6)', lineHeight: 1.7,
                  margin: '0 0 28px 0',
                }}>
                  {!isB2K ? "The ultimate fitness event of the year returns to Las Vegas, Nevada on September 24-27, 2026. Get your tickets to witness bodybuilding history live as elite champions from around the globe battle for the prestigious Sandow Trophy." : "B2K is back on stage celebrating their 25th anniversary. The 28-city reunion tour features Bow Wow, Jeremih, Pretty Ricky, Amerie, and more, kicking off in Columbia, SC, and routing across the country. Don't miss this historic R&B reunion live!"}
                </p>
                <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
                  ...
                  >
                    {!isB2K ? "View Schedule" : "Join The Live Stream"}
                  </button>
                </div>
              </div>
            </div>
