              ...
              {isOlympian 
                ...
                : (isB2K 
                  ...
                  : (isTenant 
                    ...
                    : "Vibe Network is the leading enterprise-grade, decentralized digital media ecosystem. We empower creators, sports syndicates, and corporate organizations to launch fully customized, high-fidelity white-label networks (Network-of-Networks) with direct audience interaction and native monetization."
                  )
                )
              }
            </motion.p>
            
            {!(isOlympian || isB2K || isTenant) ? (
              <>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '32px' }}>
                  <motion.div 
                    initial={{ opacity: 0, y: 20 }}
                  ...
                  >
                    ...
                    <p style={{ color: 'var(--text-secondary)', fontSize: '17px', lineHeight: 1.8, margin: 0 }}>
                      We believe in digital media sovereignty. Content creators and enterprise organizations should not be subject to third-party algorithm changes, restrictive policy updates, or shared revenue models. Vibe Network provides you with your own independent platform, allowing you to own your data, your branding, and 100% of your audience's attention.
                    </p>
                  </motion.div>
                ...
                <div style={{ marginTop: '20px' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px' }}>
                    <motion.div 
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ delay: 0.4 }}
                      style={{ background: 'var(--bg-surface)', padding: '32px', borderRadius: '24px', border: '1px solid var(--bg-surface-hover)' }}
                    >
                      <h3 style={{ fontSize: '20px', fontWeight: 800, margin: '0 0 10px 0', color: accentColor }}>
                        Dynamic Tenancy
                      </h3>
                      <p style={{ color: 'var(--text-secondary)', fontSize: '15px', lineHeight: 1.6, margin: 0 }}>
                        Configure custom domains, upload logos, set brand-specific accent colors, and manage layout themes instantly. Your network looks and feels entirely yours.
                      </p>
                    </motion.div>
                    ...
                    >
                      ...
                      <p style={{ color: 'var(--text-secondary)', fontSize: '15px', lineHeight: 1.6, margin: 0 }}>
                        Deliver ultra-low latency live video feeds and content streams using optimized media servers, featuring automatic date-sorted interleaving and RSS feed syndication.
                      </p>
                    </motion.div>
                    ...
                    >
                      ...
                      <p style={{ color: 'var(--text-secondary)', fontSize: '15px', lineHeight: 1.6, margin: 0 }}>
                        Drive active engagement and monetize views with real-time websocket chat rooms, direct tipping, appointment booking calendars, and integrated merchandise stores.
                      </p>
                    </motion.div>
                  </div>
                </div>
                ...
                >
                  ...
                  <p style={{ margin: 0, fontSize: '17px', color: 'var(--text-primary)', lineHeight: 1.8 }}>
                    Vibe Network is the foundational infrastructure for the next generation of independent media. Join our growing federation of networks and take control of your digital broadcasting future.
                  </p>
                </motion.div>
              </>
            ) : (
