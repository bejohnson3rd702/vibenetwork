...
const STATIC_COURTNEY_BEE_CLIPS: VideoClip[] = [
  ...
  },
  {
    ...
    thumbnail: 'https://i.ytimg.com/vi/f9N1o3p0KVE/hqdefault.jpg',
    videoUrl: 'https://www.youtube.com/watch?v=f9N1o3p0KVE',
    duration: 540,
    source: "Wild 'N Out",
    sport: 'wildnout'
  },
  {
    id: 'R9K1o43wM0E',
    headline: "Courtney Bee Live Interview & Comedy Special",
    description: "Courtney Bee breaks down life, dating, and rising through the comedy scene.",
    thumbnail: 'https://i.ytimg.com/vi/R9K1o43wM0E/hqdefault.jpg',
    videoUrl: 'https://www.youtube.com/watch?v=R9K1o43wM0E',
    duration: 890,
    source: "Courtney Bee Comedy",
    sport: 'standup'
  },
  {
    id: 'FwT8G8Z-zOQ',
    headline: "Joining Wild 'N Out & Advice for Rising Comedians | Courtney Bee",
    description: "Courtney Bee shares her inspiring journey from social media creator to Wild 'N Out star.",
    thumbnail: 'https://i.ytimg.com/vi/FwT8G8Z-zOQ/hqdefault.jpg',
    videoUrl: 'https://www.youtube.com/watch?v=FwT8G8Z-zOQ',
    duration: 680,
    source: "Courtney Bee Comedy",
    sport: 'standup'
  },
  {
    id: '4y-5oG_Q1_M',
    headline: "Sip With Courtney Bee | Uncensored Talk & Comedy",
    description: "Courtney Bee joins Sip With Sienna for candid talk on comedy, dating, and culture.",
    thumbnail: 'https://i.ytimg.com/vi/4y-5oG_Q1_M/hqdefault.jpg',
    videoUrl: 'https://www.youtube.com/watch?v=4y-5oG_Q1_M',
    duration: 840,
    source: "Courtney Bee Comedy",
    sport: 'standup'
  },
...
const VIBE_100_CLIPS: VideoClip[] = [
  ...
  },
  {
    ...
    description: "Rewind to the platinum-selling #1 single 'Bump, Bump, Bump' off B2K's hit record.",
...
const B2K_CLIPS: VideoClip[] = [
  ...
  {
    id: 'b2k-clip-1',
    headline: "B2K - Bump, Bump, Bump (Official Music Video)",
    description: "Watch B2K's smash #1 hit single 'Bump, Bump, Bump' featuring P. Diddy.",
    thumbnail: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?auto=format&fit=crop&q=80&w=800',
    videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4',
    duration: 253,
    source: 'B2K Channel',
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?auto=format&fit=crop&q=80&w=800',
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1598387993441-a364f854c3e1?auto=format&fit=crop&q=80&w=800',
