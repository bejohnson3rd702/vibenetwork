...
async function run() {
  console.log("🔄 Reading crm_schema.sql...");
  ...
  if (error) {
    ...
    console.log("\n=========================================================================");
    console.log("⚠️  ACTION REQUIRED: YOU MUST DEPLOY THE CRM TABLES MANUALLY.");
    ...
    console.log("✅ CRM tables, indexes, and RLS policies successfully deployed!", data);
  }
}
